...
public class BestEffortBroadcast {
    ...
    /** Consumer function to deliver a given proposal to the upper layer given its type */
    private static  Consumer<Proposal> proposalConsumer, ackConsumer, nackConsumer;
    ...
    public static void start(int port, Consumer<Proposal> proposalConsumer, Consumer<Proposal> ackConsumer, Consumer<Proposal> nackConsumer) throws SocketException {
        BestEffortBroadcast.proposalConsumer = proposalConsumer;
        BestEffortBroadcast.ackConsumer = ackConsumer;
        BestEffortBroadcast.nackConsumer = nackConsumer;
